...
const ALL_SCENES = [
  ...
  // new
  's-agrabah','s-desert-night','s-cave-gold','s-genie-blue','s-palace-ornate',
  's-wonderland','s-tea-party','s-chess-field','s-midnight-blue',
  's-enchanted-cottage','s-pumpkin-magic','s-ballroom',
  's-arctic-blue','s-ice-palace','s-aurora-sky',
  's-coral-sea','s-deep-ocean','s-sea-witch-lair','s-beach-shore',
  's-london-night','s-neverland-sky','s-pirate-ocean',
  's-puppet-workshop','s-whale-belly',
  's-tower-purple','s-lantern-sky',
];
